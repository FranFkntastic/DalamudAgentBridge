...
public sealed class Plugin : IDalamudPlugin
{
        ...
        ITextureReadbackProvider textureReadbackProvider)
    {
        ...
        bridgeHost = new AgentBridgeHost(
            ...
            (internalName, isDev) => pluginLifecycle.GetRuntimeIdentity(internalName, isDev),
